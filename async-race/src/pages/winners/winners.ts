...
export class Winners extends BaseComponent {
    ...
    async allWin() {
        ...
        allWinners.sort((a: IWinnerWithID, b: IWinnerWithID) => b.wins - a.wins);
    ...
    getCarSvgTag(color: string) {
        ...
        svgCar.classList.add('winners__svg-car');
        svgCar.innerHTML = `<svg version="1.1" class="winners__svg-car  width="10" height="5"xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" xml:space="preserve">
